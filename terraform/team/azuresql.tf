resource "azurerm_mssql_server" "gamesqlserver" {
...
resource "azurerm_mssql_database" "gamedb" {
  name           = "gamedb"
  server_id      = azurerm_mssql_server.gamesqlserver.id
  max_size_gb    = 32
  sku_name       = "GP_Gen5_8"
}
